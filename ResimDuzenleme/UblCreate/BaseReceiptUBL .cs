...
namespace ResimDuzenleme.UblCreate
{
    public class BaseReceiptUBL
    {
        ...
        public void DespatchSupplierParty()
        {
            ...
            {
                Party = BaseReceiptUBL.createParty("ResimDuzenleme BİLİŞİM TEKNOLOJİLERİ ANONİM ŞİRKETİ", "ISTANBUL", "Yıldız Teknik Üniversitesi Teknoloji Geliştirme Bölgesi D2 Blok Z07", "MALTEPE", "34220", "TR", "KÜÇÜKYALI", "8508111199", "", "operasyonekibi@ResimDuzenleme.com.tr", "4840847211"),
        ...
        public void CreateDelivery()
        {
            ...
            {
                Party = BaseReceiptUBL.createParty("akbil teknolojileri", "ANKARA", "DENEME ADRES BİLGİLERİ", "KAHRAMANKAZAN", "", "TÜRKİYE", "KURUMLAR", "(800) 811-1199", "", "yazilim@ResimDuzenleme.com.tr", "4840847211"),
            };
