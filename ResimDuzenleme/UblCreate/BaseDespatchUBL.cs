...
namespace ResimDuzenleme.UblCreate
{
    public class BaseDespatchUBL
    {
        ...
        public static PartyType createParty(string partyName, string cityName, string telephone, string telefax, string mail, string VKN)
        {
            ...
            party.WebsiteURI = new WebsiteURIType { Value = "https://www.ResimDuzenleme.com.tr" };
        ...
        public void createSignature( )
        {
            var signature = new[]
            {
                new SignatureType
                {
                    ...
                    SignatoryParty = BaseDespatchUBL.createParty("ResimDuzenleme BİLİŞİM TEKNOLOJİLERİ AŞ","İSTANBUL","2122121212","21211111111","defaultgb@ResimDuzenleme.com.tr","4840847211"),
        ...
        public void CreateDelivery( )
        {
            ...
            {
                Party = BaseDespatchUBL.createParty("ResimDuzenleme BİLİŞİM TEKNOLOJİLERİ AŞ", "İSTANBUL", "2122121212", "2122221111", "defaultgb@ResimDuzenleme.com.tr", "4840847211"),
            };
        ...
        public void Shipment( )
        {
            var shipment = new ShipmentType
            {
                ...
                Delivery = new DeliveryType
                {
                    ...
                    CarrierParty = BaseDespatchUBL.createParty("ResimDuzenleme BİLİŞİM TEKNOLOJİLERİ AŞ", "ISTANBUL", "2122121212", "2122221111", "defaultgb@ResimDuzenleme.com.tr", "4840847211"),
