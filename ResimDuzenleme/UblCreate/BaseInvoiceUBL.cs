...
namespace ResimDuzenleme.UblCreate
{
    public class BaseInvoiceUBL
    {
        ...
        public void createSignature( )
        {
            var signature = new[]
            {
                new SignatureType
                {
                    ...
                    SignatoryParty = BaseInvoiceUBL.createParty("ResimDuzenleme BİLİŞİM TEKNOLOJİLERİ AŞ","ISPARTA","2122121212","defaultgb@ResimDuzenleme.com.tr","4840847211"),
        ...
        public void AccountSupplierParty( )
        {
            ...
            {
                Party = BaseInvoiceUBL.createParty("ResimDuzenleme BİLİŞİM TEKNOLOJİLERİ AŞ", "ISPARTA", "2122121212", "defaultgb@ResimDuzenleme.com.tr", "4840847211"),
            };
            ...
            var deliveryArr = new[]
              {
                  new DeliveryType
                  {
                     DeliveryParty=BaseInvoiceUBL.createParty("ResimDuzenleme BİLİŞİM TEKNOLOJİLERİ AŞ", "ISPARTA", "2122121212", "defaultgb@ResimDuzenleme.com.tr","4850888211"    ),
