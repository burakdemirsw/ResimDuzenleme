...
namespace ResimDuzenleme.UblCreate
{
    public class BaseCreditNoteUBL
    {
        ...
        public void SupplierParty()
        {
            ...
            {
                Party = BaseCreditNoteUBL.createParty("ResimDuzenleme BİLİŞİM TEKNOLOJİLERİ AŞ", "Yıldız Teknik üniversitesi Teknopark B Blok Kat:2", "412", "Esenler", "Davutpaşa", "İstanbul", "34065", "Turkey", "4840847211"),
            };
