...
namespace ResimDuzenleme
{
    public partial class NebimIrsaliyeListesi : Form
    {
        ...
        public FrmIrsaliyeFaturalastirTekli FrmIrsaliyeFaturalastirTekliRef { get; set; }
        private void NebimIrsaliyeListesi_Load(object sender, EventArgs e)
        {
        ...
        private void gridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (hitInfo.InRow || hitInfo.InRowCell)
            {
                ...
                if (FrmIrsaliyeFaturalastirTekliRef != null)
                {
                    FrmIrsaliyeFaturalastirTekliRef.TextBox1Text = invoiceNumber;
        ...
        private DataTable LoadNebimOzellikForm(string storeCode)
        {
            ...
            {
                using (SqlCommand command = new SqlCommand("MSG_GetIrsaliyeGorsel", connection))
                {
